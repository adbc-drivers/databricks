...
// Use fork with WithArrowNativeGeospatial() support (SPARK-54232)
replace github.com/databricks/databricks-sql-go => github.com/jatorre/databricks-sql-go v0.0.0-20260314085253-353c13bb069f

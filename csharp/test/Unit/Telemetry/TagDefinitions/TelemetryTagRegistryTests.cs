...
namespace AdbcDrivers.Databricks.Tests
{
    public class TelemetryTagRegistryTests
    {
        ...
        [Fact]
        public void TelemetryTagRegistry_GetDatabricksExportTags_ReturnsImmutableSet()
        {
            // Act
            var tags = TelemetryTagRegistry.GetDatabricksExportTags(TelemetryEventType.ConnectionOpen);

            // Assert - verify the returned set is read-only
            Assert.IsAssignableFrom<IReadOnlySet<string>>(tags);
        }

...
All files must have Apache 2.0 license headers with "ADBC Drivers Contributors" copyright.
...
**Important:** The CI checks for license headers using Apache RAT. All new files must include the appropriate header or the build will fail.
